...
Route::middleware('auth')->group(function () {
    ...
    Route::get('/all-tasks', [TaskController::class, 'showTasks'])->name('tasks.showTasks');
    Route::post('/sign-out', [UserController::class, 'signOut'])->name('signOut');
    Route::get('/shared', [TaskController::class, 'getMySharedTasks'])->name('tasks.shared');
    Route::get('my-tasks', [TaskController::class, 'showMyTasks'])->name('tasks.showMyTasks');
    Route::get('/task', [\App\Http\Livewire\TaskDetailView::class])->name('task');
});
